import { IProducts, IForm, ICategory } from "../interfaces";
...
export const productList: IProducts[] = [
  ...
  {
    id: uuid(),
    title: "Macbook Pro Beside White Ipad",
    description:
      "As luxury T-Shirt is just as distinctive and can be trimmed with premium materials like Nappa leather and carbon fiber.",
    imageURL:
...
export const formInputsList: IForm[] = [
  {
    id: "title",
    name: "title",
    label: "Product Title",
    type: "text",
    placeholder: "Please write this title.....",
  },
  {
    id: "description",
    name: "description",
    ...
    type: "text",
    placeholder: "Please Write this description.....",
  },
  {
    id: "image",
    name: "imageURL",
    ...
    type: "text",
    placeholder: "Please Write link URL this image.....",
  },
  {
    id: "price",
    name: "price",
    label: "Product Price",
    type: "text",
    placeholder: "Please Write this Price.....",
  },
];
